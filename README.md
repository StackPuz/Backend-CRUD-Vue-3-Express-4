# Backend-CRUD-Vue-3-Express-4
Boilerplate Backend CRUD Web App created with Vue 3 + Express 4 by [StackPuz](https://stackpuz.com).
...
## Installation
1. Clone this repository. `git clone https://github.com/stackpuz/Backend-CRUD-Vue-3-Express-4.git .`
2. Change directory to Vue project. `cd Backend-CRUD-Vue-3-Express-4/vue`
